...
```sh
1 Download & Install: XAMPP in C:\xampp (default) Or In Mac: Applications\xampp
2 Clone this repository in C:\xampp\htdocs | in mac Applications\xampp\htdocs
3 Run XAMPP and start "Apache" and "MySQL"
4 Open the link "localhost/phpmyadmin/"
5 Click on new at sidebar and create a database name "redcastle"
After clicking database click import and select the file "hotelredcastle.sql"
