...
<head>
    ...
    <title>Hotel Red Castle - Admin</title>
    <!-- fontowesome -->
...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            ...
            <!-- //hear we want to add salary -->
            <label for="salary">Salary :</label>
            <input type="number" name="salary" class="form-control" min="0" placeholder="Enter salary" required>
        ...
        if (isset($_POST['addstaff'])) {
            ...
            $sql = "INSERT INTO staff(name, work, salary) VALUES ('$staffname', '$staffwork', '$salary')";
        ...
        while ($row = mysqli_fetch_array($re)) {
            echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <div class='mb-1'>Salary: ₹" . $row['salary'] . "</div>
